...
public class JuegoDanielActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_daniel3);
    ...
    private void referenciar() {
        ...
        uno = findViewById(R.id.correct);
        dos = findViewById(R.id.mal1);
        cuatro = findViewById(R.id.mal2);
    ...
    private void bien() {
        ...
        builder.setPositiveButton("Siguiente", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent ir = new Intent(getApplicationContext(),JuegoDanielActivity4.class);
                startActivity(ir);
            }
        });
