...
public class JuegoDanielActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_daniel5);
    ...
    private void referenciar() {
        ...
        uno = findViewById(R.id.correc);
        dos = findViewById(R.id.mal3);
        cuatro = findViewById(R.id.mal4);
